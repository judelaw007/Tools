...
-- Index for lookups
CREATE INDEX idx_allocations_course ON course_tool_allocations(course_id);
CREATE INDEX idx_allocations_tool ON course_tool_allocations(tool_id);
...
CREATE INDEX idx_usage_tool ON tool_usage_logs(tool_id);
CREATE INDEX idx_usage_created ON tool_usage_logs(created_at);
...
CREATE OR REPLACE FUNCTION get_courses_for_tool(p_tool_id UUID)
