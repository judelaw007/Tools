...
export function Sidebar({ variant = 'user', isCollapsed = false, onToggleCollapse, isMobile = false, onMobileClose }: SidebarProps) {
    ...
    >
      ...
      {isMobile ? (
        <button
          ...
          className="absolute right-3 top-5 p-1 rounded-lg hover:bg-slate-100 transition-colors"
        >
